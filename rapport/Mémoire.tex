...
Le compromis biais-variance permet de quantifier le compromis approximation-estimation lorsque la fonction de perte utilisée est celle des erreurs au carré (squared errors)
