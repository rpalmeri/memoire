...
Dans cette sous-section, les simulations ont été réalisées sur la base d'un changement de nombre d'échantillons utilisés par l'algorithme pour définir un modèle. Afin d'obtenir un moyenne d'erreur correcte, chaque algorithme crée 20 modèles différents.
...
Dans la figure \ref{LR_SampleCount}, on remarque que le biais est faible dès les premières valeurs d'échantillons et qu'il s'approche de zéro. Pour ce qui est de la variance, elle a tout d'abord une valeur supérieure à 2 lors des premières valeurs d'échantillons mais se rapproche de zéro lorsque l'on atteint 4000 échantillons. \newline

Dans la partie de droite, on remarque que l'erreur totale ne semble pas diminuer en dessous d'approximativement 6.9 mais qu'entre 1000 et 4000 échantillons, on observe une augmentation prononcée juste avant une diminution tout aussi impressionnante avant que l'erreur totale ne se stabilise.
...
Dans la figure \ref{DT_SampleCount},
...
Dans la figure \ref{BAG_SampleCount},
...
Dans la figure \ref{RF_SampleCount},
...
\begin{thebibliography}{9}
	...
	consulté le 21 Juin 2021 10:16
